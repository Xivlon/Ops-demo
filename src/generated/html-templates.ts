...
// Generated at: 2026-02-22T21:27:15.931Z
  ...
  <script>
    ...
    async function loadShipments() {
        ...
        try {
            ...
            showToast("Connection issue - showing cached data", "yellow");
        }
    }
    ...
    function formatTimeRemaining(pickupTime) {
    ...
    function renderTable() {
        ...
        tbody.innerHTML = list.map(s => {
            ...
            const timeRemaining = s.pickup_time ? formatTimeRemaining(s.pickup_time) : '';
...
<body class="bg-slate-900 text-slate-100 min-h-screen">
  ...
  <script>
    ...
    async function loadDriverStats() {
      try {
        const res = await fetch('/api/drivers/stats/live', {
          headers: { 'Accept': 'application/json' },
          credentials: 'include'
        });
